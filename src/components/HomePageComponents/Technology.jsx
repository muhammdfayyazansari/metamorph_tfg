...
//         <div className="bg-hero-combo flex items-center gap-3 rounded-full px-5 py-3 font-medium capitalize whitespace-nowrap">
//             <img
//                 src={icon}
//                 alt={`${name} icon`}
...
//             {techItems.map((item, index) => (
//                 <CardItem key={`duplicate-${index}`} name={item.name} icon={item.icon} />
//             ))}
//         </div>
//     );
