export default function PeopleCard({
  ...
  return (
    <div
      className={`glass card-gradient flex flex-col-reverse lg:flex-row gap-3 
      rounded-3xl p-8 
      w-[900px] min-w-[900px]
      ${extraClass}`}
    >
      ...
      {/* RATING + QUOTES (UNCHANGED POSITION) */}
      <div className="flex flex-col items-end lg:items-center justify-center">
        ...
        />
        <img
          className="w-40 rounded-xl object-contain opacity-40"
