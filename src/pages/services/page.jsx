...
const ServicesPage = () => {
  ...
  useGSAP(() => {
    ...
    // --- Scroll-based active state only ---
  ...
  <title>Digital Design & Creative Services | Metamorph Solutions</title>

  <meta
    name="description"
    content="Explore Metamorph Solutions’ creative services including branding, UI/UX design, motion graphics, animation, digital marketing, and custom digital solutions."
  />

  <link rel="canonical" href="https://metamorph.solutions/services" />

  {/* Open Graph */}
  <meta property="og:title" content="Digital Design & Creative Services | Metamorph Solutions" />
  <meta
    property="og:description"
    content="Creative digital services covering branding, UI/UX, motion design, animation, and performance-driven marketing."
  />
  <meta property="og:url" content="https://metamorph.solutions/services" />
  <meta property="og:type" content="website" />
      ...
      {/* Fixed Side Navigation (Scroll indicator only) */}
      <div
        ref={navRef}
        ...
        <div className="glass card-gradient flex flex-col items-center justify-around space-y-15 rounded-l-2xl p-3">
          {sectionData.map((item) => (
            <div
              key={item.id}
              data-target={item.id}
              className="nav-icon relative cursor-default transition-all duration-300"
              title={item.title}
            >
              <div className="rounded-lg bg-transparent p-2 transition-all duration-500">
                <img
