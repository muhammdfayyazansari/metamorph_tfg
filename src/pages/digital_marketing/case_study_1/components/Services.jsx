const items = [
  {
    id: 1,
    title: 'Case study',
    subTitle: 'Transforming business to global agency',
    desc: 'Enhanced Alpha web studio experience for seamless worldwide deliveries, driving a 3x increase in international orders while optimizing operational efficiency without extra costs.',
    leads: '3x',
    ads: '36%',
