  ...
  return (
    <div className="relative flex w-full flex-col py-10">
      ...
      <div className="z-10 flex w-full flex-col items-center gap-10 py-10 px-6 lg:px-30">
        <div className="relative z-10 w-full max-w-7xl overflow-hidden rounded-3xl shadow-2xl">
          <img
            className="w-full h-auto object-contain"
            src="/images/digitalMarketingCS/largeuxImgTwo.svg"
            alt="Large UX Showcase"
          />
        </div>
      </div>

      {/* Decorative Iridescent Ring - Placed just before the Other Case Studies section */}
